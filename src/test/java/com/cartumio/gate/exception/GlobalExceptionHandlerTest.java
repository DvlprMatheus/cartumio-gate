...
class GlobalExceptionHandlerTest {
    ...
    void testHandleEmailFailedException() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleEmailFailedException(
                exception, request);
    ...
    void testHandleGenericException() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleGeneric(exception, request);
